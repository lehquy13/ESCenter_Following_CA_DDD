...
namespace ESCenter.Persistence.Migrations
{
    ...
    [Migration("20240410134657_UpdateReviewAndChangeVerificationToAuditableObject")]
    partial class UpdateReviewAndChangeVerificationToAuditableObject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ESCenter.Domain.Aggregates.Courses.Course", b =>
                {
                    ...
                    b.OwnsOne("ESCenter.Domain.Aggregates.Courses.Entities.Review", "Review", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("Id");
